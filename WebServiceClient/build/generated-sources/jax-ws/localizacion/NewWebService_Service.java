 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://localizacion/", wsdlLocation = "http://localhost:8080/WebServices/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://localizacion/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://localizacion/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localizacion/", "NewWebServicePort"), NewWebService.class, features);
    }
